...
*/
CKEDITOR.lang['fr'] = {
	"editor" : "", // EDIT : "Éditeur de Texte Enrichi"
	"editorPanel" : "Tableau de bord", // EDIT : "Tableau de bord de l'éditeur de texte enrichi"
	"common" : {
	...
	"autosave" : {
		"dateFormat" : "LLL",
		"autoSaveMessage" : "Brouillon mis en mémoire",
		"loadSavedContent" : "Un brouillon mis en mémoire le {0} a été trouvé. Voulez-vous le comparer avec celui de la page et choisir lequel charger ?",
		"title" : "Comparer le brouillon mis en mémoire avec le brouillon de la page",
		"loadedContent" : "Brouillon de la page",
		"autoSavedContent" : "Brouillon mis en mémoire le ",
		"ok" : "Charger le brouillon mis en mémoire",
		"no" : "Annuler",
		"diffType" : "Type de visualisation",
