/*! doT.js | Templating Library | https://github.com/olado/doT | ver. 1.0.1 | Copyright 2011, Laura Doktorova | Licensed under the MIT license. | http://www.opensource.org/licenses/mit-license.php */
...
d,k,s){if(!d)return"';} } out+='";f+=1;g=s||"i"+f;d=m(d);return"';var arr"+f+"="+d+";if(arr"+f+"){var "+k+","+g+"=-1,l"+f+"=arr"+f+".length-1;while("+g+"<l"+f+"){"+k+"=arr"+f+"["+g+"+=1];out+='"}).replace(b.evaluate||i,function(h,d){return"';"+m(d)+"out+='"})+"';return out;").replace(/\n/g,"\\n").replace(/\t/g,"\\t").replace(/\r/g,"\\r").replace(/(\s|;|\}|^|\{)out\+='';/g,"$1").replace(/\+''/g,"").replace(/(\s|;|\}|^|\{)out\+=''\+/g,"$1out+=").replace(/(\\r)?(\\n)?(\\t)*'/g,"'");if(e&&b.selfcontained)a="String.prototype.encodeHTML=("+
