...
function connect() {
  // Set Connect Class
  $("#main").toggleClass("connect"); // Connection tag -- rather ugly ...
  // Toggle Launcher Visibility
  $(".connect-launcher").toggleClass("hide");
  // Toggle User Navigation Visibility
  $(".user-nav").toggleClass("hide");
  ...
  if (!$("#main").hasClass("connect")) { // Temporary way of holding disconnection ; should delete content and redirect
